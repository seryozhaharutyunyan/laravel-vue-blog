...
export default {
    ...
    methods: {
        ...
        update() {
            ...
            if (this.passwordUpdate) {
                ...
                url = this.$store.getters.getUrlRoot + '/registration/password';
            } else if (this.accountUpdate) {
                data.append('password', this.userData.password);
                data.append('country_id', this.userData.country_id);
                data.append('img', this.userData.img);
                url = this.$store.getters.getUrlRoot + '/registration/account';
            } else {
                return;
            }
    ...
    created() {
        this.query(this.$store.getters.getUrlRoot + '/registration');
