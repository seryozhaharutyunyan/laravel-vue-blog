        ...
        <div>
            <header>
                ...
                <div>
                    ...
                    <router-link class="m-1 fs-3 text-muted" :to="{name: 'registration'}">Registration</router-link>
                </div>
            </header>
...
export default {
    ...
    methods: {
        ...
        login() {
            ...
            api.post(this.url + '/auth/login', data)
                .then(r => {
                    console.log(r);
                    this.err = '';
        ...
        reset() {
            if (this.captcha === this.newCaptcha) {
                this.errCaptcha = '';
                this.emailErr = '';
                api.post(this.url + '/registration/reset_password', {
                    email: this.email,
                })
                    .then(() => {
